...
#   1. Run ruby seqpar_no_extend_benchmark.rb
#   2. cp after.dat before.dat 
#   3. Make your modifications to the treetop code
#   4. Run ruby seqpar_no_extend_benchmark.rb
...
class SeqParBenchmark
  ...
  def initialize
    ...
    grammar = File.join(@where, 'seqpar_no_extend.treetop')
    output = File.join(@where, 'seqpar_no_extend.rb')
